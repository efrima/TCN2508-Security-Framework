...
# --- TELEMETRY SETUP ---
# Satisfies Lab 3 & Page 1: "Integrate telemetry with a logging/visualisation stack"
# FIX: Removed basicConfig to prevent global override
# FIX: Define a specific logger for Vulnerability Scanner
...
class VulnScanner:
    ...
    def load_db(self):
        """
        Loads the LOCAL/Whitelisted CVE database (Page 2 Architecture).
        """
    ...
    def save_report(self, filename="[recon]_vuln_report.json"):
        """
        Satisfies 'CSV/JSON export for findings' requirement (Page 2).
        Includes both open ports and identified vulnerabilities.
        """
        try:
            report_data = {
